...
\footnotesize\bfseries\color{sectioncolour}{Technology Lead} & \scriptsize\bfseries\color{sectioncolour}{August 2024 - Present}\\
\multicolumn{2}{p{\linewidth}}{
    \scriptsize{\vspace{-0.1in}\begin{itemize}[nosep]
        \item Led feature development on 5-person backend team, using Deno, PostgreSQL, Supabase, and Google Cloud Platform.
        \item Created GitHub Actions CI/CD deployment pipelines, implemented JWT-based authentication.
